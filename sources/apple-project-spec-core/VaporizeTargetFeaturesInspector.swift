...
public enum VaporizeTargetFeaturesInspector {
  ...
  private static func inspectGeneratedXcconfigs(
    ...
    return manifest.tiers.map { tier in
      ...
      let generatedByDigikoma = text?.contains("digikoma-release-features") ?? false
  ...
  private static func minimumInspections(
    ...
    return [
      ...
      minimum(
        ...
        detail: digikomaProvenancePresent ? "generated files carry digikoma-release-features provenance" : "generated file provenance is missing"
      ),
    ]
  }
...
public struct VaporizeTargetFeaturesInspectionReceipt: Codable, Equatable, Sendable {
  ...
  public var boundaries = [
    ...
    "First slice supports wrkstrm release-features topology generated by digikoma-release-features.",
