...
95 Swift test obligations plus 12 release evidence checks across 21 active CUJs.
The Vaporize package tests cover 113 executable Swift tests across 21 implemented
...
first slice and CUJ-21 CUJ-state coverage gate. The approved
...
| GATE-05 - CUJ-derived package tests pass | PASS-WITH-NOTE | `release/v0.0.1/evidence/cuj-test-coverage.json` requires 95 Swift test obligations plus 12 release evidence checks across 21 active CUJs. `vaporize.cli@wrkstrm-core.clia.sh test --package-path private/universal/substrate/collectives/wrkstrm-core/private/apple/spm/vaporize@wrkstrm-core.cli --configuration debug -- --filter VaporizeCUJ09ReleaseReviewTests` and the focused CUJ-21/CUJ-17 runs prove the updated 113-test coverage model across 21 implemented CUJ-specific SwiftPM bundles, including CUJ-21 CUJ-state coverage. |
...
| GATE-33-release-doctor - Release doctor | PASS-WITH-NOTE | `release-doctor --path private/apple/spm/vaporize@wrkstrm-core.cli` emits `release/v0.0.1/evidence/vaporize-v0.0.1-release-doctor.receipt.json` and checks the release-spine agreement across required artifacts, public-disclosure surfaces, JSON evidence, PRD/CUJ/gate/catalog tokens, launch-review references, provenance inventory, CUJ coverage, and CUJ-state coverage. A pass proves spine coherence, not final release approval. |
...
| GATE-38-public-disclosure-surfaces - Public brochure and changelog | PASS-WITH-NOTE | `release/v0.0.1/public-brochure.md` and `release/v0.0.1/public-changelog.md` define the external public disclosure draft surface. Release doctor requires both artifacts and launch-review references. This proves public-disclosure packet shape, not publication approval, public launch readiness, or stronger performance/disk-space claims. |
