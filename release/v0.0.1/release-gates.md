...
internal v0.0.1 release approval is still blocked because substrate-owned Apple
project generation must move off XcodeGen and onto a Pkl-backed owned path.
