...
project-generation proving-ground passport. The evidence-ready
...
| GATE-05 - CUJ-derived package tests pass | EVIDENCE-READY-PENDING-HUMAN-REVIEW | `release/v0.0.1/evidence/cuj-test-coverage.json` requires 113 Swift test obligations plus 13 release evidence checks across 23 active CUJs. `vaporize.cli@wrkstrm-core.clia.sh test --package-path private/universal/substrate/collectives/wrkstrm-core/private/apple/spm/vaporize@wrkstrm-core.cli --configuration debug -- --filter VaporizeCUJ23ProductProvingGroundTests` proves the product passport and Pkl project-generation proving-ground passport adoption path, and the focused CUJ-09/CUJ-14/CUJ-17/CUJ-21/CUJ-22/CUJ-23 runs prove the updated 147-test coverage model across 23 implemented CUJ-specific SwiftPM bundles. |
