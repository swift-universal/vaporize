...
105 Swift test obligations plus 12 release evidence checks across 22 active CUJs.
The Vaporize package tests cover 139 executable Swift tests across 22 implemented
...
release identity on tool targets. The evidence-ready
