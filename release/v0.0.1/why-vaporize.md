...
| Assistants improvise shell choreography | One canonical command surface for build, test, install, run, open, validate, inspect, import, generate, list targets, list workspace schemes, inventory, and toolchain selection | README, PRD FR-001 through FR-030, 20 CUJ bundles |
...
| Full Vaporize suite through Vaporize toolchain | `vaporize toolchain -- swift test` | Latest verification: 107 tests across 20 CUJ bundles; earlier `/usr/bin/time` baseline: `15.57s real`, 82 tests |
