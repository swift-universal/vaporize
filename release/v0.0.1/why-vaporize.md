...
| Assistants improvise shell choreography | One canonical command surface for build, test, install, run, open, validate, inspect, import, generate, list targets, list workspace schemes, inventory, and toolchain selection | README, PRD FR-001 through FR-031, 21 CUJ bundles |
...
| Full Vaporize suite through Vaporize toolchain | `vaporize toolchain -- swift test` | Latest coverage model: 113 tests across 21 CUJ bundles after CUJ-21 coverage-gate additions; earlier `/usr/bin/time` baseline: `15.57s real`, 82 tests |
