...
| Full Vaporize suite through Vaporize toolchain | `vaporize toolchain -- swift test` | Latest coverage model: 147 tests across 23 CUJ bundles after CUJ-14 graph/scheme generation, CUJ-17 follow-up coherence, CUJ-22 resource-bearing CLI install, and CUJ-23 product plus Pkl generator proving-ground passport additions; earlier `/usr/bin/time` baseline: `15.57s real`, 82 tests |
