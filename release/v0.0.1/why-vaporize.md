...
| Full Vaporize suite through Vaporize toolchain | `vaporize toolchain -- swift test` | Latest coverage model: 138 tests across 22 CUJ bundles after CUJ-22 resource-bearing CLI install additions; earlier `/usr/bin/time` baseline: `15.57s real`, 82 tests |
