...
| CUJ-23 | FR-033 | 4 Swift tests; 1 release evidence check | Product proving-ground passport profile, generator capability passport for Pkl project generation, incomplete-passport failure, reusable product-class track catalog, release-doctor coverage |
