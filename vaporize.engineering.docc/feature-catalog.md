...
| Feature-scoped test lifecycle | A major tool needs tests grouped by user journey so each feature can be targeted during development and release review. | CUJ-specific SwiftPM test bundles and `feature-test-lifecycle.md` | CUJ-09 enforces the coverage contract; v0.0.1 has 17 implemented CUJ bundles. |
