...
| Vaporware product proving grounds | Release reviewers need to know which evidence tracks a product has actually driven before trusting a launch packet. | Typed proving-ground passports and `product-proving-grounds.md` | CUJ-23 proves a Vaporize CLI passport, a Pkl project-generation generator passport, incomplete-passport failure, reusable product-class track defaults, and release-doctor coverage; see <doc:product-proving-grounds>. |
